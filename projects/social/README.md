...
The percentage of other users in a particular user's extended social network would be 99% and the average degree of separation between a user and their extended network is 10.
